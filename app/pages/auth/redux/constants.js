...
export const USER_LOGIN = `${namespace}/redux/user-login`;
export const USER_LOGIN_SUCCESS = `${namespace}/redux/user-login-success`;
export const USER_LOGIN_FAIL = `${namespace}/redux/user-login-fail`;
